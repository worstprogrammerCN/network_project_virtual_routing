...
public class Controller {
    ...
    private JButton switchButton;                   // Start listening to other hosts
    ...
    private class HostThread extends Thread {
        ...
        public HostThread(Socket socket) {
            try {
                ...
                // the form is like "MEMBERLIST${@param ip1}${@param ip2}" 
        ...
        public void handleMessage(String message) {
        	...
        	switch (mode) {
                ...
                case "IF_MODIFIED": // Host ask if the routing state has been modified
                    if (!modifying) {
        		...
        		case "UPDATE": // Host asks for updating routing state
                    modifying = true;
                    Map<String, Integer> newLinkCost = new HashMap<>();
